...
const std::string& Request::get_prefix() const { return prefix; }

const std::string& Request::get_command() const { return command; }

const std::vector<std::string>& Request::get_params() const { return params; }
