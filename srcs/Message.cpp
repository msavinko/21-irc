...
const std::vector<std::string> &Message::get_params() const { return parameters; }
const std::string &Message::get_prefix() const { return prefix; }
const std::string &Message::get_command() const { return command; }
